...
type ChordClient interface {
	...
	GetHashFuncName(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HashFuncResponse, error)
	// Chord Protocol RPCs
...
func (c *chordClient) GetHashFuncName(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HashFuncResponse, error) {
	out := new(HashFuncResponse)
	err := c.cc.Invoke(ctx, "/pb.Chord/GetHashFuncName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChordServer interface {
	// Chord Integrity RPCs
	GetHashFuncName(context.Context, *Empty) (*HashFuncResponse, error)
	// Chord Protocol RPCs
...
func (UnimplementedChordServer) GetHashFuncName(context.Context, *Empty) (*HashFuncResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHashFuncName not implemented")
}
...
func _Chord_GetHashFuncName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChordServer).GetHashFuncName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Chord/GetHashFuncName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChordServer).GetHashFuncName(ctx, req.(*Empty))
	}
...
var Chord_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetHashFuncName",
			Handler:    _Chord_GetHashFuncName_Handler,
		},
		{
