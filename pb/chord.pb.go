...
var file_pb_chord_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x32, 0xbf, 0x02, 0x0a, 0x05, 0x43, 0x68, 0x6f, 0x72, 0x64, 0x12, 0x36,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x79, 0x75, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x2d, 0x63, 0x68,
...
var file_pb_chord_proto_depIdxs = []int32{
	...
	1, // 6: pb.Chord.GetHashFuncCheckSum:output_type -> pb.HashFuncResponse
	4, // 7: pb.Chord.GetSuccessor:output_type -> pb.AddressResponse
	4, // 8: pb.Chord.ClosestPrecedingFinger:output_type -> pb.AddressResponse
	4, // 9: pb.Chord.FindSuccessor:output_type -> pb.AddressResponse
	4, // 10: pb.Chord.GetPredecessor:output_type -> pb.AddressResponse
	0, // 11: pb.Chord.Notify:output_type -> pb.Empty
